...
namespace School {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class supplierDataTable : global::System.Data.TypedTableBase<supplierRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public supplierRow AddsupplierRow(string com_name, string name, string type, string email, int contact_number, int fax, string web_address) {
        ...
        public partial class supplierRow : global::System.Data.DataRow {
            ...
            public string com_name {
                get {
                    return ((string)(this[this.tablesupplier.com_nameColumn]));
                }
                set {
                    this[this.tablesupplier.com_nameColumn] = value;
                }
            }
...
namespace School.DataSet2TableAdapters {
    ...
    public partial class supplierTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[supplier] WHERE (([id] = @Original_id) AND ([com_name] = @Original_com_name) AND ([name] = @Original_name) AND ([type] = @Original_type) AND ([email] = @Original_email) AND ([contact_number] = @Original_contact_number) AND ((@IsNull_fax = 1 AND [fax] IS NULL) OR ([fax] = @Original_fax)) AND ((@IsNull_web_address = 1 AND [web_address] IS NULL) OR ([web_address] = @Original_web_address)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[supplier] ([com_name], [name], [type], [email], [contact_number], [fax], [web_address]) VALUES (@com_name, @name, @type, @email, @contact_number, @fax, @web_address);
SELECT id, com_name, name, type, email, contact_number, fax, web_address FROM supplier WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[supplier] SET [com_name] = @com_name, [name] = @name, [type] = @type, [email] = @email, [contact_number] = @contact_number, [fax] = @fax, [web_address] = @web_address WHERE (([id] = @Original_id) AND ([com_name] = @Original_com_name) AND ([name] = @Original_name) AND ([type] = @Original_type) AND ([email] = @Original_email) AND ([contact_number] = @Original_contact_number) AND ((@IsNull_fax = 1 AND [fax] IS NULL) OR ([fax] = @Original_fax)) AND ((@IsNull_web_address = 1 AND [web_address] IS NULL) OR ([web_address] = @Original_web_address)));
SELECT id, com_name, name, type, email, contact_number, fax, web_address FROM supplier WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, com_name, name, type, email, contact_number, fax, web_address FROM dbo" +
                ".supplier";
        ...
        public virtual int Delete(int Original_id, string Original_com_name, string Original_name, string Original_type, string Original_email, int Original_contact_number, global::System.Nullable<int> Original_fax, string Original_web_address) {
            ...
            if ((Original_fax.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_fax.Value));
            }
            else {
            ...
            if ((Original_web_address == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_web_address));
            }
        ...
        public virtual int Insert(string com_name, string name, string type, string email, int contact_number, global::System.Nullable<int> fax, string web_address) {
            if ((com_name == null)) {
            ...
            if ((web_address == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(web_address));
            }
        ...
        public virtual int Update(
            ...
            if ((web_address == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(web_address));
            }
            ...
            if ((Original_com_name == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_com_name));
            }
            if ((Original_name == null)) {
                throw new global::System.ArgumentNullException("Original_name");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_contact_number));
            if ((Original_fax.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[13].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_fax.Value));
            }
            else {
            ...
            if ((Original_web_address == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_web_address));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string com_name, string name, string type, string email, int contact_number, global::System.Nullable<int> fax, string web_address, int Original_id, string Original_com_name, string Original_name, string Original_type, string Original_email, int Original_contact_number, global::System.Nullable<int> Original_fax, string Original_web_address) {
            return this.Update(com_name, name, type, email, contact_number, fax, web_address, Original_id, Original_com_name, Original_name, Original_type, Original_email, Original_contact_number, Original_fax, Original_web_address, Original_id);
        }
    }

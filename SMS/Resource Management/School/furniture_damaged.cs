...
namespace School
{
    public partial class furniture_damaged : MetroForm
    {
        ...
        private void furniture_damaged_Load(object sender, EventArgs e)
        {
            display();
        }
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmd1 = new SqlCommand("update furniture set quantity = quantity + '" + qun + "' where itemname = '" + name + "'", con);

...
namespace School
{
    public partial class lab : MetroForm
    {
        ...
        private string[] combobox2RangeF1 = new[] { "", "", "3", "4" };
        ...
        private void metroComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (selectedValue)
            {
                ...
                case "Books":
                    metroComboBox2.Items.Clear();
                    metroComboBox2.Items.AddRange(combobox2RangeF1);
                    break;
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               // SqlCommand cmd = new SqlCommand("update lab set quantity = quantity + '" + qun + "' where itemname = '" + name + "'", con);
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE lab  SET itemcategory='" + metroComboBox1.SelectedItem + "',itemname='" + metroComboBox2.SelectedItem + "', quantity='" + metroTextBox1.Text + "', date= '" + dateTimePicker1.Value.ToString("MM/dd/yyyy") + "' where id = '" + textBoxX1.Text + "'", con);
                cmd.ExecuteNonQuery();
                con.Close();

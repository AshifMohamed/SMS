...
namespace School
{
    public partial class comlab_arc : MetroForm
    {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd2 = new SqlCommand("insert INTO krida_arc ( itemcategory, itemname, quantity, date ) VALUES('" + metroComboBox1.GetItemText(metroComboBox1.SelectedItem) + "','" + metroComboBox2.GetItemText(metroComboBox2.SelectedItem) + "','" + metroTextBox1.Text + "','" + dateTimePicker1.Value.ToString("MM/dd/yyyy") + "')", con);
                int qun = Convert.ToInt32(this.metroTextBox1.Text);
                string name = metroComboBox2.GetItemText(metroComboBox2.SelectedItem);
               // SqlCommand cmd1 = new SqlCommand("update comlab_arc set quantity = quantity + '" + qun + "' where itemname = '" + name + "'", con);
                //SqlCommand cmd2 = new SqlCommand("update comlab set quantity = quantity - '" + qun + "' where itemname = '" + name + "'", con);
        ...
        private void comlab_arc_Load(object sender, EventArgs e)
        {
            display();
        }
